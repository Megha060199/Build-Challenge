...
# ASSIGNMENT 1 PRODUCER CONSUMER THREAD SYNCHORNOISATION -  Bounded Blocking Queue (MQ)
...
- `test-coverage.png` - contains the test coverage
...
# ASSIGNMENT 2 Data Analysis (Streams/Functional)
...
- Required Python 3.10+ (tested with 3.13).
- Clone: `git clone <repo-url> && cd SuperStore-Data-Streaming-Analysis`
...
- Additional dataset notes present in `DATASET_NOTES.md`


## Running analyses
-  Run the all analyses from the project root:
  ``` bash
